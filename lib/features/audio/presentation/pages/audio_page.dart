...
سياسة الخصوصية لتطبيق أذكار وأدعية العفاسي
              ...
              child: filteredSupplications.isEmpty
                  ...
                  : Builder(
                      builder: (context) {
                        const adFrequency = 3;
                        final int adCount =
                            filteredSupplications.length ~/ adFrequency;
                        final int itemCount =
                            filteredSupplications.length + adCount;

                        return ListView.builder(
                          // نزيد العدد لإدراج إعلانات بين العناصر
                          itemCount: itemCount,
                          itemBuilder: (context, index) {
                            // عرض إعلان بعد كل ثلاثة عناصر
